        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-600 mb-7 text-sm sm:text-base leading-relaxed">
              ...
              <p>
                Инвестирахме в съвременно диагностично оборудване и непрекъснато обучение на нашия екип, за да обслужваме всички марки автомобили — от класически европейски модели до най-новите японски и корейски коли.
              </p>
              <p>
